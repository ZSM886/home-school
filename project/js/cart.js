...
$("#Shop").html($("#Shop").html()+html);
    ...
    $(".goods-op").click(function(){
      ...
      $("body").append('<div class="shade"><div class="choose"><div class="select"><span>删除 <em>×</em></span><img src="../img/icon48.png" class="icon_img"><p>删除商品?<br/><em>您可以选择移到关注，或删除商品。</em></p><button class="choose-yes">是</button><button class="choose-no">添加到收藏</button></div></div>')
