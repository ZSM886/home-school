...
$.ajax({
  ...
  "success": function(response){
    ...
    for(var i=0;i<obj.data.length;i++){
      $("#shop").append('<div class="goodsInfo"><a href="goods.html?goods_id='+obj.data[i].goods_id+'" ><div class="smallGoodsThumb"><img src="' + obj.data[i].goods_thumb + '" alt=""/><div class="zoom"></div></div></a><p><h3><a href="goods.html?goods_id='+obj.data[i].goods_id+'" class="goodsName">商品名称:' +obj.data[i].goods_name+ '</a></h3></p><p class="goodsDesc"><span>商品简介:</span>' +obj.data[i].goods_desc+  '</p><p class="goodsPrice"><span>商品价格:</span>￥' +obj.data[i].price+  '</p><div class="bigGoodsThumb"><img src="'+obj.data[i].goods_thumb+'" class="oimg"><div></div>');
    }
