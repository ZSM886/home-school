...
$.ajax({
  ...
  "success":function(response){
	...
	for(var j=0;j<obj.page.page_count;j++){
		$("#ButtonCenter").append( $('<button type="button" class="btn btn-default">'+(j+1)+'</button>') );
	}
  }
});}
